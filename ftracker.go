...
func RunningSpentCalories(action int, weight, duration float64) float64 {
    // ваш код здесь
    runningCals := ((runningCaloriesMeanSpeedMultiplier*meanSpeed(action, duration)*runningCaloriesMeanSpeedShift)*weight/mInKm*duration*minInH)
	return runningCals
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
    // ваш код здесь
    speedMpS := meanSpeed(action, duration)*kmhInMsec
    walkingCals :=  ((walkingCaloriesWeightMultiplier*weight + (math.Pow(speedMpS, 2)/(height/cmInM))*walkingSpeedHeightMultiplier*weight)*duration*minInH)
	return walkingCals
}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
    // ваш код здесь
    swimmingCals := (swimmingMeanSpeed(lengthPool, countPool, duration) + swimmingCaloriesMeanSpeedShift)*swimmingCaloriesWeightMultiplier*weight*duration
	return swimmingCals
}
